...
enum {
    ...
    UCT_IB_IFACE_STAT_RX_CHECK_CQE,
    UCT_IB_IFACE_STAT_HW_OWNED_POLL,
    UCT_IB_IFACE_STAT_POLL,
    UCT_IB_IFACE_STAT_POLL_CYCLES,
    UCT_IB_IFACE_STAT_POLL_USUAL_CYCLES,
    UCT_IB_IFACE_STAT_POLL_EXTRA_CYCLES,
    UCT_IB_IFACE_STAT_POLL_HW_OWNED_CYCLES,
    UCT_IB_IFACE_STAT_POLL_CHECK_CYCLES,
